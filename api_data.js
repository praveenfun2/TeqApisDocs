define({ "api": [
  ...
  },
  {
    ...
    "title": "Advertisement",
    "group": "Advertisement",
    "description": "<p>Get advertisement posters for a location.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>Advertisement poster filenames.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "international",
            "description": "<p>International coverage commission.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>Upload advertisement image. This will be shown to different users publicly according to the scheme chosen.</p>",
    "group": "Advertisement",
    "parameter": {
      "examples": [
        {
        ...
        "400": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>Either the dates or the type is not correct.</p>"
          }
        ],
        "402": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>Payment Service not working.</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "./src/main/java/com/neo/Controller/Seller/AdvertisementController.java",
    "groupTitle": "Advertisement",
    "name": "PostSellerAdNew"
  },
  {
    "type": "get",
  ...
  {
    "type": "get",
    "url": "/customer/card/remove",
    "title": "Delete user card",
    "description": "<p>Delete a card design uploaded by customer.</p>",
    "group": "Cards",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "version": "0.0.0",
    "filename": "./src/main/java/com/neo/Controller/Customer/CardsController.java",
    "groupTitle": "Cards",
    "name": "GetCustomerCardRemove"
  },
  {
    "type": "get",
    "url": "/seller/card",
  ...
  {
    "type": "post",
    "url": "/customer/card/new",
    "title": "New user card",
    "description": "<p>Upload a new card design by customer.</p>",
    "group": "Cards",
    "parameter": {
      "examples": [
        {
  ...
  {
    "type": "post",
    "url": "/seller/card/promotion",
    "title": "Card promotion.",
    "description": "<p>Provide card discount prices.</p>",
    "group": "Cards",
    "parameter": {
      "examples": [
        {
    ...
    "filename": "./src/main/java/com/neo/Controller/Seller/CardsController.java",
    "groupTitle": "Cards",
    "name": "PostSellerCardPromotion"
  },
  {
    "type": "post",
    "url": "/seller/card/update",
    "title": "Update Card",
    "description": "<p>Update an existing card design</p>",
    "group": "Cards",
    "parameter": {
      "fields": {
        "Parameter": [
        ...
        "400": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>The request params are malformed.</p>"
          }
        ],
        "403": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>Seller is not forbidden to update the card.</p>"
          }
        ]
      }
    },
        ...
        "403": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>The paper finish is used in the card design.</p>"
          }
        ],
        "404": [
          {
        ...
        "403": [
          {
            ...
            "optional": false,
            "field": "-",
            "description": "<p>The paper quality is used in the card design.</p>"
          }
        ],
        "404": [
          {
